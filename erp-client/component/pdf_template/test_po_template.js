...
import styles from "./po_printing.module.css";
      ...
      <Container disableGutters="false">
        <Grid container spacing={1} mt={2}>
          ...
          <Grid container spacing={1} mt={1} ml={1}>
            ...
            <Grid container>
              <Grid item xs={12}>
                <div style={styles.printing}>
                  <table aria-label="simple table">
                    <thead>
                      <tr>
                        <td align="center">編號 </td>
                        <td align="left">品名規格</td>
                        <td align="center">是否需燒錄</td>
                        <td align="center">封裝</td>
                        <td align="right">數量 (PIECES)</td>
                        <td align="right">單價</td>
                        <td align="right">金額</td>
                        <td align="left">預進貨日</td>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        return (
                          <>
                            <tr
                              ...
                              <td align="center">{item.BurnOption.value}</td>
                              <td align="center">{item.Packaging.value}</td>
                              <td align="right">{item.QTY}</td>
                              <td align="right">{item.UnitCost.toFixed(2)}</td>
                              <td align="right">
                        ...
                        <td align="right">
                          {poDetail.orderProduct.reduce(
                            (prev, current) =>
                              (prev +=
                                Math.round(
                                  current.QTY * current.UnitCost * 100
                                ) / 100),
                            0
                          )}
                          <br />
